...
final class MovieDetailsAPITest: XCTestCase {
    private var apiProvider: NetworkProvider<MovieDetailsAPI>!
    ...
    override func setUp() {
        ...
        expectation = .init(description: "MovieDetailsAPITest Expectation")
    }
    ...
    func test_requestSuccess() {
        // given
        let mockData = MockData.movieDetails
